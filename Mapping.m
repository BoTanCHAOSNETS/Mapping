...
weighted_grid = cell_allocate(flatted_absolute_location_original,layout_grid,x_vector,y_vector);

subplot(1,2,2), plot_weighted_grid(weighted_grid,x_vector,y_vector);
subplot(1,2,1), plot_flatted_cell(flatted_absolute_location_original);
